...
-- This differes from each environment
  ...
  BEGIN
		...
		Values
			...
			(@lobUMB,'ESBUrl','PROD',   'http://esbp.njmgroup.com:3011/PolicyDataService/CorrEditor/HOPolicyInformationRetriever',SUSER_SNAME(),GETDATE(),null,null),
...
Select @printer19=  PrinterId from ACE.dbo.Printer where PrinterCode='PRT_PL_QA1'
 ...
 (@lobwcu,@catunder, @printer17,180,DATEADD(YEAR,-1,GETDATE()),DATEADD(YEAR,90,GETDATE()),SUSER_SNAME(),GETDATE(),null,null),
 (@lobwcu,@catunder, @printer18,190,DATEADD(YEAR,-1,GETDATE()),DATEADD(YEAR,90,GETDATE()),SUSER_SNAME(),GETDATE(),null,null),
 (@lobwcu,@catunder, @printer19,200,DATEADD(YEAR,-1,GETDATE()),DATEADD(YEAR,90,GETDATE()),SUSER_SNAME(),GETDATE(),null,null)
