...
INSERT INTO [dbo].[WebService]
     ...
     VALUES
           ...
           ,'UGCP1'
           ,'SampleUrl'
           ,'http://inspiredwt1:30600/rest/api/submit-job/PreviewGCDocument'
           ,SUSER_SNAME()
           ,GETDATE()
          ),
		    (@LOBId
           ,'DGCP1'
           ,'ESBUrl'
           ,'http://esbawsd.njmgroup.com:5400/XpCCCorrGCWeb/sca/DocumentDataRepository'
           ,SUSER_SNAME()
           ,GETDATE()
          ),
		   (@LOBId
           ...
           ,'DGCLO'
           ,'ESBUrl'
           ,'http://esbawsd.njmgroup.com:3200/XpCCCorrGCWeb/sca/DocumentDataRepository'
           ,SUSER_SNAME()
           ,GETDATE()
          ),
		   (@LOBId
