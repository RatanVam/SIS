...
Select @lobPCUMB=  lobId from dbo.LOB where LOBName='PC-DW'
...
-- This differes from each environment
  ...
  BEGIN
		 INSERT INTO [dbo].[WebService] (LOBId,URLType,Environment,URL
		  ...
		  ,[UpdatedDateTime])
		Values
			(@lobPCUMB,'ESBUrl','ISUD', 'http://esbu.njmgroup.com:7413/PolicyDataService/CorrEditor/HOPolicyInformationRetriever',SUSER_SNAME(),GETDATE(),null,null),
			(@lobPCUMB,'SampleUrl','ISUD','http://inspireuat:30600/rest/api/submit-job/PreviewPCHUDDcoument',SUSER_SNAME(),GETDATE(),null,null),
			(@lobPCUMB,'ESBUrl','ISU1', 'http://esbu.njmgroup.com:3012/PolicyDataService/CorrEditor/HOPolicyInformationRetriever',SUSER_SNAME(),GETDATE(),null,null),
...
Select @lobPCUMB=  lobId from dbo.LOB where LOBName='PC-DW'
Select @prinerCategory=  CategoryId from dbo.Category where CategoryName='PL_UNDERWRITING_DW'
INSERT INTO [dbo].[LOBPrinter]
  (    [LOBId]
      ,[PrinterId]
      ,[PrinterOrder]
