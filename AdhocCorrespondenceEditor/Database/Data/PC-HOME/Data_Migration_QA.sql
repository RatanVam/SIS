...
-- This differes from each environment
  ...
  BEGIN
		...
		Values
			...
			(@lobWCU,'SampleUrl','ISQ2','http://inspireqa:30600/rest/api/submit-job/PreviewPCHUDDcoument',SUSER_SNAME(),GETDATE(),null,null),
			(@lobWCU,'SampleUrl','ISQ3','http://inspireqa:30600/rest/api/submit-job/PreviewPCHUDDcoument',SUSER_SNAME(),GETDATE(),null,null),
			(@lobWCU,'SampleUrl','ISQ6','http://inspireqa:30600/rest/api/submit-job/PreviewPCHUDDcoument',SUSER_SNAME(),GETDATE(),null,null),
			(@lobWCU,'ESBUrl','ISQ1', 'http://esbq.njmgroup.com:7413/PolicyDataService/CorrEditor/HOPolicyInformationRetriever',SUSER_SNAME(),GETDATE(),null,null),
			(@lobWCU,'ESBUrl','ISQ2', 'http://esbq.njmgroup.com:3012/PolicyDataService/CorrEditor/HOPolicyInformationRetriever',SUSER_SNAME(),GETDATE(),null,null),
			(@lobWCU,'ESBUrl','ISQ3', 'http://esbq.njmgroup.com:3012/PolicyDataService/CorrEditor/HOPolicyInformationRetriever',SUSER_SNAME(),GETDATE(),null,null),
			(@lobWCU,'ESBUrl','ISQ6', 'http://esbq.njmgroup.com:7413/PolicyDataService/CorrEditor/HOPolicyInformationRetriever',SUSER_SNAME(),GETDATE(),null,null)
...
Select @printer20=  PrinterId from dbo.Printer where PrinterCode='PRT_PL_QA1'
Select @printer21=  PrinterId from dbo.Printer where PrinterCode='ACLB10'
