...
-- This differes from each environment
  ...
  BEGIN
		 INSERT INTO ACE.[dbo].[WebService] (LOBId,URLType,Environment,URL
		  ...
		  ,[UpdatedDateTime])
		Values
			(@lobWCU,'ESBUrl','ISD2','http://172.25.7.17:2613/PolicyDataService/UMCorrespondenceData',SUSER_SNAME(),GETDATE(),null,null),
			(@lobWCU,'ESBUrl','ISD1','http://172.25.7.17:3039/PolicyDataService/UMCorrespondenceData',SUSER_SNAME(),GETDATE(),null,null),
