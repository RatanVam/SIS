...
CREATE TABLE [dbo].[Rule](
	...
	[RuleNameSpace] [varchar](500) NOT NULL,
	[RuleMethod] [varchar](500)  NOT NULL,
...
(
 ...
 CONSTRAINT [PK_T_Rule_uq] UNIQUE NONCLUSTERED 
(
	[RuleName] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] 
...
ALTER TABLE [dbo].[RuleItem] CHECK CONSTRAINT [FK_RuleItem_Document]
...
IF OBJECT_ID(N'dbo.RuleLookup', N'U') IS  NULL
BEGIN

CREATE TABLE [dbo].[RuleLookup](
 ...
 CONSTRAINT [PK_T_RuleLookup] PRIMARY KEY CLUSTERED 
(
	[RuleLookupId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY],
 CONSTRAINT [PK_T_RuleLookup_uq] UNIQUE NONCLUSTERED 
(
	[RuleItemId],
	[LookupKey]
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
ALTER TABLE [dbo].[RuleLookup]  WITH CHECK ADD  CONSTRAINT [FK_RuleLookupItem] FOREIGN KEY([RuleItemId])
REFERENCES [dbo].[RuleItem] ([RuleItemId])
ALTER TABLE [dbo].[RuleLookup] CHECK CONSTRAINT [FK_RuleLookupItem]


EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This table store data for each key' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'RuleLookup'
PRINT 'Rule Lookup Table Created'
END

ELSE
PRINT 'Rule Lookup Table alredy exist'