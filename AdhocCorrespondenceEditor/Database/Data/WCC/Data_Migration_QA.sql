...
INSERT INTO [dbo].[WebService]
     ...
     VALUES
           ...
           ,'QWCCP1'
           ,'ESBUrl'
           ,'http://esbq.njmgroup.com:7003/XpCorrESBWeb/sca/GetCorrData'
           ,SUSER_SNAME()
           ,GETDATE()
          ),
		   (@LOBId
           ,'QWCCP1'
           ,'SampleURL'
           ,'http://inspireqa:30600/rest/api/submit-job/PreviewWCCDocument'
           ,SUSER_SNAME()
           ,GETDATE()
          ),
		   (@LOBId
		  ...
		  (@LOBId
           ,'QWCLO'
           ,'ESBUrl'
           ,'http://esbq.njmgroup.com:3403/XpCorrESBWeb/sca/GetCorrData'
           ,SUSER_SNAME()
           ,GETDATE()
          ),
		   (@LOBId
