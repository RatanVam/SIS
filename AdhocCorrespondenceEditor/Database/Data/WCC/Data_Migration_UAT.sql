...
INSERT INTO [dbo].[WebService]
     ...
     VALUES
           ...
           ,'UWCLO'
           ,'ESBUrl'
           ,'http://esbu.njmgroup.com:3403/XpCorrESBWeb/sca/GetCorrData'
           ,SUSER_SNAME()
           ,GETDATE()
          ),
		   (@LOBId
           ,'UWCLO'
           ,'SampleUrl'
           ,'http://inspireuat:30600/rest/api/submit-job/PreviewWCCDocument'
           ,SUSER_SNAME()
           ,GETDATE()
          ),
		   (@LOBId
           ,'UWCP1'
           ,'ESBUrl'
           ,'http://esbu.njmgroup.com:7003/XpCorrESBWeb/sca/GetCorrData'
           ,SUSER_SNAME()
           ,GETDATE()
          ),
		   (@LOBId
...
('PRT_WC_MFP3',	'PRT_WC_MFP3',1,SUSER_SNAME(),GETDATE(),null,null),
...
Declare @Prt15 int =( select PrinterId from Printer where PrinterName = 'PRT_WC_MFP3')
