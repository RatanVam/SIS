...
-- This differes from each environment
  ...
  BEGIN
		 INSERT INTO ACE.[dbo].[WebService] (LOBId,URLType,Environment,URL
		  ...
		  ,[UpdatedDateTime])
		Values
			(@lobWCU,'ESBUrl','ISUD', 'http://esbu.njmgroup.com:1034/PolicyDataService/UMCorrespondenceData',SUSER_SNAME(),GETDATE(),null,null),
			(@lobWCU,'ESBUrl','ISU1', 'http://esbu.njmgroup.com:3013/PolicyDataService/UMCorrespondenceData',SUSER_SNAME(),GETDATE(),null,null),
			(@lobWCU,'SampleUrl','ISUD','http://inspireuat:30600/rest/api/submit-job/PreviewPCHUDDcoument',SUSER_SNAME(),GETDATE(),null,null)
   END
