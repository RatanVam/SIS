...
{
    public class PCCUMBService : ISourceSystemBase
    {
        ...
        public SourceSystemBaseEntity GetDataByPolicyNumber(SourceSystemInputRequest Details, ProxyServiceModelHelpers helpers)
        {
            ...
            try
            {
                ...
                request.RetrievePolicyByPolicyNumberRequestMessage.AsOfDate = Details.AsOfDate.ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:sszzz");// "2023-06-19T12:00:00.00-00:00";// Details.AsOfDate.ToUniversalTime();
                ...
                request.RetrievePolicyByPolicyNumberRequestMessage.Header.Requestor.SystemIdentity = "ICE";
                request.RetrievePolicyByPolicyNumberRequestMessage.Header.Requestor.UserIdentity = "user";
                var client = new CUMBPolicyInfomationRetrieverClient(helpers.binding, helpers.endpointAddress);
